...
public class CoffeeImageGenerator {
    public static void main(String[] args) {
        String[] coffeeNames = {"Americano", "Latte", "Cappuccino", "Mocha", "Caramel_Macchiato", "Flat_White"};
        String[] chineseNames = {"美式咖啡", "拿铁咖啡", "卡布奇诺咖啡", "摩卡咖啡", "焦糖玛奇朵咖啡", "馥芮白咖啡"};
        
        // 设置输出目录
        String outputDir = "g:\\CoffeeOrderSystem\\back\\Coffee-Order-System\\src\\main\\resources\\static\\coffee_image\\";
        
        for (int i = 0; i < coffeeNames.length; i++) {
            generateCoffeePlaceholder(outputDir + coffeeNames[i] + ".jpg", chineseNames[i]);
        }
